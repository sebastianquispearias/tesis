...
VT_ROOT_DEFAULT    = Path(r"C:\Users\User\Desktop\tesis\data\Corrosion Condition State Classification\Corrosion Condition State Classification\512x512")
AMELI_ROOT_DEFAULT = Path(r"C:\Users\User\Desktop\tesis\data\corrosion images\corrosion images")  # carpeta que contemple /train/images, /validation/images, /test/images
