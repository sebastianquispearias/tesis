...
ARCHITECTURES = ['baseline', 'pspnet', 'fpn']  # usado en modo supervisado 'baseline', 'pspnet', 'fpn'
...
if __name__ == '__main__':
    ...
    if mode == "supervised":
        ...
        for arch in ARCHITECTURES:
            ...
            logging.info(f"[supervised] ✔ Cargado mejor modelo de validación desde {best_path}")
                    ...
                    for x_lab, y_lab, x_unl_s, x_unl_t in train_mixed_loader:
                     # → Teacher sobre versión débil
                        ...
                        with tf.GradientTape() as tape:
                            ...
                            s_unl_probs = tf.cast(s_unl_probs, tf.float32)
