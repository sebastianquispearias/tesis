...
def get_weak_augmentation(input_shape):
    ...
    return A.Compose([
        A.Resize(*input_shape[:2]),
        # sólo resize (puedes añadir un flip suave si quieres)
    ])
...
if __name__ == '__main__':
    ...
    # ───── LÓGICA “SEMI” (Mean Teacher para Cxx) ─────
        ...
        train_mixed_loader = MixedDataLoader(
            ...
            batch_size_lab=4,
            batch_size_unlab=4,
            augment_lab=strong_aug,  # Fuerza las transformaciones fuertes para el estudiante
            augment_unlab=strong_aug,  # También fuerte para el estudiante en no etiquetados
